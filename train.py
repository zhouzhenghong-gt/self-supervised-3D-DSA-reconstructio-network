...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_input_path', type=str, default='/home/zhenghongzhou/repo/DSA_reconstruct/dataset/traindata',
                        help='Path to the "ShapeNet.json"')
    parser.add_argument('--train_output_path', type=str, default='/home/zhenghongzhou/repo/DSA_reconstruct/dataset/traingt',
                        help='Path to the "ShapeNet.json"')
    parser.add_argument('--result_path', type=str, default='/home/zhenghongzhou/repo/code_dsa/output',
                        help='Path to the "ShapeNet.json"')
